    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo" target="_blank">
          ...
          <span class="logo-lg"><i class="fa fa-home"></i><b> ECOMMERCE STORE</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <?php $isPosLoggedIn = $this->session->userdata('isPosLoggedIn'); ?>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php if(isset($isPosLoggedIn)) { echo $isPosLoggedIn['name']; } ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php if(isset($isPosLoggedIn)) { echo $isPosLoggedIn['name']; }?>
                    </p>
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>store-logout" class="btn btn-danger btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="<?php echo base_url(); ?>Billing/orderHistory">
