                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                <a href="<?php echo base_url(); ?>home"><h1 class="text-primary">Login</h1></a>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <form action="<?php echo base_url(); ?>loginsubmit" class="" method="POST" id="signin">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <a href="<?php echo base_url(); ?>signup" class="w-100 btn form-control border-secondary py-3 bg-white text-primary" role="button">Register</a>
                                    </div>
                                </div>
                            </form>
                        </div>
